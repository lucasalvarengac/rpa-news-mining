...
def producer():
    ...
    def parse_news(news, search_term, selenium):
        ...
        try:
            ...
            description = ""
        created_at = selenium.find_element(
    ...
    def run_task():
        for item in workitems.inputs:
            ...
            try:
                ...
                search_bar = selenium.wait_until_page_contains_element(
                    "xpath://div[@data-element='search-overlay']", timeout=15
                )
                search_input = selenium.find_element(
                ...
                selenium.wait_until_page_contains_element(
            ...
            if category:
                ...
                see_all = selenium.find_element(
                    "xpath://span[contains(.,'See All')]", category_toggler
                )
                selenium.click_element(see_all)
                try:
                    category_element = selenium.find_element(
                        f"xpath=//span[contains(.,'{category}')]", category_toggler
                    )
